...
def compute_average_scores(model_folders):
    ...
    file_map = {
        "aggregated_long_refined.json": "average_long.json",
        "aggregated_short_l6_refined.json": "average_short_l6.json",
        "aggregated_short_l6v2_refined.json": "average_short_l6v2.json"
    }
